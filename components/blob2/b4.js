    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        .main-blob {
          ...
          background: radial-gradient(70.32% 70.88% at 50% 20%, #D8D9E6 0%, #EBDDE1 35%, #FFB8D3 57%, #F2D4D2 100%);
          border-radius: 50%;
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.5),
            0 0 8px 2px rgba(255, 184, 211, 0.3);
        }
        ...
        .trail-1 {
          ...
          filter: blur(17px);
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.4),
            0 0 6px 2px rgba(255, 184, 211, 0.25);
        }
        ...
        .trail-2 {
          ...
          filter: blur(19px);
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.35),
            0 0 6px 2px rgba(255, 184, 211, 0.2);
        }
        ...
        .trail-3 {
          ...
          filter: blur(21px);
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.3),
            0 0 6px 2px rgba(255, 184, 211, 0.15);
        }
        ...
        .trail-4 {
          ...
          filter: blur(23px);
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.25),
            0 0 6px 2px rgba(255, 184, 211, 0.1);
        }
        ...
        .trail-5 {
          ...
          filter: blur(25px);
          box-shadow: 
            0 0 0 2px rgba(255, 184, 211, 0.2),
            0 0 6px 2px rgba(255, 184, 211, 0.08);
        }
